...
class MustBuy(TopModel):
    position = models.IntegerField(default=1)
    class Meta:
        db_table = "axf_mustbuy"  # 必购

class TopShop(TopModel):
    position = models.IntegerField(default=1)
    class Meta:
        db_table = "axf_shop"  # 热点商品
...
class MainShow(models.Model):
    ...
    price1 = models.CharField(max_length=10)  # 会员价
    marketprice1 = models.CharField(max_length=10) # 市场价格
...
# axf_goods(dealerid,storenums,productnum)
# ("4858",50,100002115)
